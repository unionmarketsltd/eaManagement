			...
			<div class="table-rows">
				<!-- TABLE ROW -->
					...
					<div class="table-row large">
						...
						<div class="table-row-item left">
							<img class="widget-option-img user-avatar micro" src="${clientlistinfo.google_image_url}" alt="avatar-01">
						</div>
						<div class="table-row-item left">
						...
						<div class="table-row-item left">
							...
							<button type="button" onclick="toggleban(${clientlistinfo.id},${clientlistinfo.isban})" class="button small red">Un-Ban</button>
							</c:when>
							<c:otherwise>
							<button type="button" onclick="toggleban(${clientlistinfo.id},${clientlistinfo.isban})" class="button small blue">Ban</button>
							</c:otherwise>
