           ...
           <%@include file="inc/sidemenu.jsp" %>
            ...
            <div class="layout-body">
              ...
              <div class="section-title-wrap blue no-space">
                <h2 class="section-title medium">All Forum</h2>
			...
			<div class="table-row-header">
				...
				<div class="table-row-header-item left">
					<p class="table-row-header-title">logo</p>
				</div>
				<!-- /TABLE ROW HEADER ITEM -->
				<div class="table-row-header-item left">
...
<c:forEach items="${ forumlist }" var="forumlistinfo">
				...
				<!-- TABLE ROW -->
					...
					<div class="table-row large">
						...
						<div class="table-row-item left">
							<p class="table-text bold">${forumlistinfo.id}.${forumlistinfo.name} 
							
							</p>
						</div>
						
						<div class="table-row-item left">
							<p class="table-text bold" style="max-width:300px">${forumlistinfo.description} 
							
							</p>
						</div>
						
						<div class="table-row-item left">
							<p class="table-text bold">${forumlistinfo.logo}</p>
						</div>
						
						<div class="table-row-item left">
							<p class="table-text bold">${forumlistinfo.create_by}</p>
						</div>
						
						<div class="table-row-item left">
							<p class="table-text bold">${forumlistinfo.create_date}</p>
						</div>
						
						<div class="table-row-item left">
							
						
							<a href="${pageContext.request.contextPath}/admin/forumedit?id=${forumlistinfo.id}" class="button small blue">Edit</a>
