           ...
           <%@include file="inc/sidemenu.jsp" %>
            ...
            <div class="layout-body">
              ...
              <div class="section-title-wrap blue no-space">
                <h2 class="section-title medium">Edit Category</h2>
              ...
              <div class="form-item blue">
                    ...
                    <input type="text" id="title" name="as_username" placeholder="Enter your username here..." value="${categorydetails.name}">
              ...
              <br>
               ...
               <div class="form-item blue">
                    ...
                    <input type="text" id="desc" name="as_username" placeholder="Enter your username here..." value="${categorydetails.description}">
...
<button class="button blue" style="float:right" onclick="updateforumdetails()">
	...
	function updateforumdetails()
	{
		...
		$.ajax({
			url : '${pageContext.request.contextPath}/admin/api/editcategorydetail?title='+title+'&desc='+description+'&id='+id,
			type : 'get',
...
const id = new URLSearchParams(window.location.search).get('id');
		...
		$.ajax({
			url : '${pageContext.request.contextPath}/admin/api/deletecategory?id='+id,
			type : 'get',
			datatype : "application/json",
			contentType : "application/json",
			async : true,
			...
			success : function(data) {
				console.log(data);
				window.location.href = "${pageContext.request.contextPath}/admin/categorysetting";
