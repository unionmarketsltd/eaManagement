...
<c:forEach items="${ forumlist }" var="listinfo" varStatus="status"><!-- Forums -->            
                ...
                <div class="link-sections">
                  ...
                  <c:choose>
                    ...
                    <div class="section-title-wrap violet">
                      <h2 class="section-title small"><a href="${pageContext.request.contextPath}/forum/category?id=${forumcatlist.id}">${forumcatlist.name}</a></h2>
                    ...
                    <ul class="link-list medium">
                      ...
                      <li class="link-list-item">
                        <a href="${pageContext.request.contextPath}/forum/category?id=${forumcatlist.id}">${forumcatlist.description}</a>
                      </li>
                      <!-- /LINK LIST ITEM -->
        ...
        <!-- MAIN MENU ITEM -->
        <li class="main-menu-item">
          <a href="${pageContext.request.contextPath}/home/contact" class="main-menu-item-link">Contact</a>
        </li>
        <!-- /MAIN MENU ITEM -->
