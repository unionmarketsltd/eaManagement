...
<title>Pixel Diamonwwwwd | Login &amp; Register</title>
...
<body>
  ...
  <div class="live-news-widget-wrap">
    ...
    <div class="live-news-widget grid-limit">
      ...
      <div class="live-news-widget-title-wrap">
        <img class="live-news-widget-icon" src="${pageContext.request.contextPath}/resources/forum/img/icons/live-news-icon.png" alt="live-news-icon">
  ...
  <!-- MAP WRAP -->
  <div id="map-wrap-bg-01" class="map-wrap big">
  ...
  <div class="contact-section-wrap">
    ...
    <div class="contact-section grid-limit">
      ...
      <p class="contact-section-text">Do you have a question or wanna join our team? Send us an email or a message and we’ll answer you as fast as we can!</p>
      <!-- /CONTACT SECTION TEXT -->
      ...
      <div class="social-links centered">
        <!-- BUBBLE ORNAMENT -->
        <a href="#" class="bubble-ornament hoverable fb">
          <!-- FACEBOOK ICON -->
        ...
        <!-- BUBBLE ORNAMENT -->
        <a href="#" class="bubble-ornament hoverable twt">
          <!-- TWITTER ICON -->
        ...
        <!-- BUBBLE ORNAMENT -->
        <a href="#" class="bubble-ornament hoverable insta">
          <!-- INSTAGRAM ICON -->
        ...
        <!-- BUBBLE ORNAMENT -->
        <a href="#" class="bubble-ornament hoverable twitch">
          <!-- TWITCH ICON -->
        ...
        <!-- BUBBLE ORNAMENT -->
        <a href="#" class="bubble-ornament hoverable gplus">
          <!-- GPLUS ICON -->
        ...
        <!-- BUBBLE ORNAMENT -->
        <a href="#" class="bubble-ornament hoverable youtube">
          <!-- YOUTUBE ICON -->
    ...
    <div class="subscribe-section-wrap"> 
      <div class="subscribe-section grid-limit">
        ...
        <img class="subscribe-section-img" src="${pageContext.request.contextPath}/resources/forum/img/other/newsletter_people.png" alt="subscribe-img">
        <!-- /SUBSCRIBE SECTION IMG -->
        ...
        <div class="subscribe-section-info">
          ...
          <p class="subscribe-section-text">Receive the latest news, promos, featured videos and more</p>
          <!-- /SUBSCRIBE SECTION TEXT -->
          ...
          <form class="form-wrap">
            ...
            <div class="submit-input medium green">
              <input type="text" id="newsletter_email" name="newsletter_email" placeholder="Enter your email here...">
...
<script src="${pageContext.request.contextPath}/resources/forum/app.bundle.min.js"></scrip
