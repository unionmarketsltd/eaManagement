...
<div class="login-box">
  <div class="login-logo"> <img  class=" login-box-msg" style="width: 176px;
    ...
    <br><a href="/portal/fundadmin/login">Fund Admin System </a>
  </div>
  <!-- /.login-logo -->
  <div class="card">
...
function check(){
	...
	$.ajax({
		url : '${pageContext.request.contextPath}/fundadmin/loginConfirm',
		type : 'get',
		async: false,
		...
		success : function(data) {
			...
			if (data.result == "SUCCESS") {
				self.location.href="${pageContext.request.contextPath}/fundadmin/index";
			} else {
