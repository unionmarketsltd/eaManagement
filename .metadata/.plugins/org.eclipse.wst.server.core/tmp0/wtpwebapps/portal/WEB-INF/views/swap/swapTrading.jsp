	...
	<div class="modal fade" id="modal-success" style="display: none;"
		...
		<div class="modal-dialog">
			<div class="modal-content">
				...
				<div class="modal-footer justify-content-between">
					<a href="${pageContext.request.contextPath}/swap/Positions" class="btn btn-primary " style="margin-left: auto;
...
<script type="text/javascript">
	...
	function executeBatchOrder() {
		...
		$
		.ajax({
			 url: "${pageContext.request.contextPath}/swap/executebatchorder?body="+body,
			type : 'get',
			async : false,
			data : '',
			success : function(data) {
