				...
				<form name="loginFrm" id="loginFrm">
					...
					<div id="agreediv" style="display: none">
						...
						<div class="form-check">
							<input class="form-check-input" type="checkbox" id="checkbox_tos"
								name="checkbox_tos"> <label class="form-check-label">I
								am agreed to the Term of Services</label>
						</div>
						...
						<div class="form-check">
							<input class="form-check-input" type="checkbox" id="checkbox_aml"
								name="checkbox_aml"> <label class="form-check-label">I
								am agreed to the Anti Money Laundry</label>
						</div>
						...
						<div class="form-check">
							<input class="form-check-input" type="checkbox"
								id="checkbox_risk" name="checkbox_risk"> <label
...
function isStrongPassword(password) {
	...
	function check() {
		...
		if(!isStrongPassword(document.loginFrm.Password.value) || document.loginFrm.Password.value.length<8)
			{
			alert(" Your password must be at least 8 characters long and include at least one uppercase letter, one lowercase letter, one number, and one special character (!@#$%^&*()_+{}[]:;<>,.?~\-/).")
	...
	function testPost()
	{
        ...
        var userseq = urlParams.get('userseq');
      if(userseq==null || userseq =="")
		...
		//	var base64 = document.getElementById("uploadimage").src;
			//obj.test=  base64.slice(base64.indexOf(",")+1, base64.length);
			 ...
			 obj.userseq = userseq;
			 obj.birthdaystring = document.loginFrm.PersonBirthDate.value;
		...
		.ajax({
			...
			success : function(data) {
				...
				if(data.result.indexOf("0 Done")>=0)
					{
					alert("Success,an verification email is sent to your email.")
					...
					{
					alert(data.result);
					window.location.replace("${pageContext.request.contextPath}/fundclient/signup");
					}
