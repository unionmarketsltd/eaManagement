     ...
     <li class="nav-item" title="Select Language">
                ...
                <li class="nav-item dropdown" title="Select Languages">
                    ...
                    <div class="dropdown-menu dropdown-menu-lg dropdown-menu-right">
                        ...
                        <a href="${pageContext.request.contextPath}/wallet/myprofile" class="dropdown-item">
                        ...
                        <div class="dropdown-divider"></div>
                        <a href="${pageContext.request.contextPath}/wallet/logout" class="dropdown-item dropdown-footer" title="Logout">Logout</a>
                    </div>
                </li>
