							...
							<div class="card">
								...
								<div class="card-body table-responsive p-0">
									<table class="table table-hover text-nowrap" id="datatable">
                                        ...
                                        <tr>
                                            <td><img class="uk-margin-small-right" src="${pageContext.request.contextPath}/resources/home/img/in-lazy.svg" data-src="${pageContext.request.contextPath}/resources/home/img/${list.symbol }.svg" alt="fx-flag" width="29" height="17" data-uk-img><span class="in-pairname">${list.symbol }</span></td>
                                            <td><span class="uk-label uk-label-success uk-border-pill">${list.bid }</span></td>
                                            <td><span class="uk-label uk-label-danger uk-border-pill">${list.ask }</span></td>
                                            <td class="uk-visible@s"><fmt:formatNumber value="${list.spread  }" pattern="0.0"/></td>
                                        </tr>
	                        			</c:forEach>
										</thead>
										<tbody>
...
<script type="text/javascript">
	...
	function check() {
		$
				.ajax({
					url : '${pageContext.request.contextPath}/crm/symbolTest',
					type : 'get',
					async : false,
						...
						if (data.result.indexOf("0 Done" >= 0)) {
							...
							if (jobject.retcode == "0 Done") {
								if (jobject.hasOwnProperty('answer')) {
									...
									insertTableRowWithAllColumn("datatable", jarray);
