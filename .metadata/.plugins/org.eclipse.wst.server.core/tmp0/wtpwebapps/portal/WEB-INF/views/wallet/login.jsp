...
<title>Virtual Wallet System | Log in</title>
...
<body class="hold-transition login-page">
	<div class="login-box">
		<div class="login-logo">
			<a href="/portal/wallet/login"><b>Virtual Wallet</b> System </a>
		</div>
		<!-- /.login-logo -->
		<div class="card">
				...
				<form action="${pageContext.request.contextPath}/crm/loginConfirm"
					...
					<div class="row">
						...
						<div class="row" style="text-align:center">
							<p class="mb-1 col-12">
								<a href="${pageContext.request.contextPath}/wallet/forgotpassword">I forgot my password</a>
							</p>



							<p class="mb-0 col-12">
								<a href="${pageContext.request.contextPath}/wallet/signup" class="text-center">Register a new
									account</a>
							</p>
...
<script type="text/javascript">
	function check() {
		...
		$
				.ajax({
					url : '${pageContext.request.contextPath}/wallet/loginConfirm',
					type : 'get',
					async : false,
					data : $("#loginFrm").serialize(),
					success : function(data) {
						if (data.result == "SUCCESS") {
							self.location.href = "${pageContext.request.contextPath}/wallet/index";
						} else {
