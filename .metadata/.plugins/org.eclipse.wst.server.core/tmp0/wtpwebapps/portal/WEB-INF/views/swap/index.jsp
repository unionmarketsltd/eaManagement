	...
	<div class="wrapper">
		...
		<script type="text/javascript">
			function GetOrderList(page) {
				$
						.ajax({
							url : '${pageContext.request.contextPath}/swap/IndexGetInfo',
							type : 'get',
							async : false,
							data : '',
		...
		/*	function getprofileimg() {
				...
				document.getElementById("userphoto").src = "${pageContext.request.contextPath}/swap/image/p_default.jpg";
				document.getElementById("bgprofile").style.background = "url('${pageContext.request.contextPath}/swap/image/p_default.jpg" + "') center center";
