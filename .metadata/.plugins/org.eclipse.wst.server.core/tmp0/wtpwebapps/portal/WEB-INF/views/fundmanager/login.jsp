...
<head>
  ...
  <title>Fund Manager System | Log in</title>
...
<div class="login-box">
  <div class="login-logo"> <img  class=" login-box-msg" style="width: 176px;
    ...
    <br><a href="/portal/fundmanager/login">Fund Manager System </a>
  </div>
  <!-- /.login-logo -->
  <div class="card">
    <div class="card-body login-card-body">
      ...
      <form action="${pageContext.request.contextPath}/crm/loginConfirm" method="get" name="loginFrm" id="loginFrm">
        ...
        <div class="row">
          ...
          <!-- /.col -->
          <div class="col-4">
            <button  id="signinbtn" type="button" onClick="javascript:check();" class="btn btn-primary btn-block">Sign In</button>
    ...
    <!--   <p class="mb-1">
      ...
      <strong>Copyright &copy; 2023 <a href="#"></a>.
...
function check(){
	...
	$.ajax({
		url : '${pageContext.request.contextPath}/fundmanager/loginConfirm',
		type : 'get',
		async: false,
		data : $("#loginFrm").serialize(),
		success : function(data) {
			if (data.result == "SUCCESS") {
				self.location.href="${pageContext.request.contextPath}/fundmanager/index";
			} else {
