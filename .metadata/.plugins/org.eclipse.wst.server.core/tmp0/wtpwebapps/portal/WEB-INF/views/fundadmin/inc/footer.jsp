...
<footer class="main-footer">
	<strong>Copyright &copy; 2022 <a href="#">Fund Admin</a>.
...
<script type="text/javascript">
		...
		.ajax({
			...
			success : function(data) {
				if (data.result.indexOf("0 Done" >= 0)) {
					...
					if(jobject.answer == true)
						{
						document.getElementById("cs_nav").style.display = "";
						}
	...
	if (Epagetitle.indexOf("AddMasterManager") >= 0) {
		pagetitle = "Add Master Manager";
	}
	
	if (Epagetitle.indexOf("mastersetting") >= 0) {
	...
	document.title = "FUND ADMIN | " + pagetitle;
