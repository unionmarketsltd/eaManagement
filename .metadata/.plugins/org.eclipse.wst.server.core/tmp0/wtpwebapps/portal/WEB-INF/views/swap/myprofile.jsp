								...
								<div class="card-body box-profile">
									<div class="text-center">
										<img class="profile-user-img img-fluid img-circle"
											id="profileimg"
											src="${pageContext.request.contextPath}/resources/images/Userimg/p_<%=s_Login%>.png"
						...
						<div class="col-12">
							<div class="card">
								...
								<div class="card-footer ">
									<a href="${pageContext.request.contextPath}/swap/Orders"
    ...
    ${message} <!-- here would be a message with a result of processing -->
		...
		<script>
			...
			function uploadFile() {
				...
				let response = await
				fetch('${pageContext.request.contextPath}/swap/pimageupload', {
					method : "POST",
					body : formData
				});
		...
		<script type="text/javascript">
			...
			function GetInfo(page) {
				$
						.ajax({
							url : '${pageContext.request.contextPath}/swap/myprofileGetInfo',
							type : 'get',
							async : false,
							data : '',
			...
			function GetaccountInfo(page) {
				$
						.ajax({
							url : '${pageContext.request.contextPath}/swap/myprofileGetAccountInfo',
							type : 'get',
							async : false,
							data : '',
							success : function(data) {
			...
			function GetPositionList(page) {
				$
						.ajax({
							url : '${pageContext.request.contextPath}/swap/PositionGetList?page='
									+ page,
							type : 'get',
							async : false,
								...
								if (data.result.indexOf("0 Done" >= 0)) {
									...
									if (jobject.retcode == "0 Done") {
										if (jobject.hasOwnProperty('answer')) {
											...
											if (Object.keys(Jarrayanswer).length > 0) {
												document
														.getElementById("profileimg").src = "${pageContext.request.contextPath}/swap/image/"
														+ Jarrayanswer.url;
			...
			function deleteprofileimg() {
				$
						.ajax({
							url : '${pageContext.request.contextPath}/swap/deleteProfileImg',
							type : 'get',
							async : false,
							data : $("#accountListFrm").serialize(),
							success : function(data) {
