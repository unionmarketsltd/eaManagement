...
<body class="hold-transition login-page">
	<div class="login-box">
		<div class="login-logo"> <img  class=" login-box-msg" style="width: 176px;
    border-radius: 33px;" src="${pageContext.request.contextPath}/resources/dist/img/AdminLTELogo.jpg">
    <br>
    <b><span style="font-size:18px">Seiren Holdings</span></b>
    <br><a href="/portal/fundclient/login">Fund Client System </a>
  </div>
		<!-- /.login-logo -->
		<div class="card">
				...
				<form action="${pageContext.request.contextPath}/crm/loginConfirm"
					...
					<div class="row">
						...
						<br>
							...
							<!-- <p class="mb-1 col-12">
								<a href="${pageContext.request.contextPath}/fundclient/forgotpassword">I forgot my password</a>
							</p> -->



							<p class="col-12"style="text-align:center;margin: auto">
								<a href="${pageContext.request.contextPath}/fundclient/signup" class="text-center">Register a new
									account</a>
							</p>
...
<script type="text/javascript">
	function check() {
		...
		$
				.ajax({
					url : '${pageContext.request.contextPath}/fundclient/loginConfirm',
					type : 'get',
					async : true,
					data : $("#loginFrm").serialize(),
					success : function(data) {
						if (data.result == "SUCCESS") {
							self.location.href = "${pageContext.request.contextPath}/fundclient/index";
						} else {
