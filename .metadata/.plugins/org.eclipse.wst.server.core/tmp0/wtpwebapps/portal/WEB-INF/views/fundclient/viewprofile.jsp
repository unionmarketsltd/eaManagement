	...
	<div class="wrapper">
						...
						<div class="col-sm-6">
							<ol class="breadcrumb float-sm-right">
								<li class="breadcrumb-item"><a
									href="${pageContext.request.contextPath}/fundclient/allMaster">Master</a></li>
		...
		<script type="text/javascript">
			function copyMaster() {
				...
				$
						.ajax({
							url : '${pageContext.request.contextPath}/fundclient/checkAmIMaster',
							type : 'get',
							async : false,
							data : '',
			...
			function isCopier() {
				...
				$
						.ajax({
							url : '${pageContext.request.contextPath}/fundclient/isCopier?mid='+master,
							type : 'get',
							async : false,
							data : '',
							success : function(data) {
			...
			function checkCopyStatus() {
				...
				$
						.ajax({
							url : '${pageContext.request.contextPath}/fundclient/checkCopyStatus?mid='+master,
							type : 'get',
							async : false,
							data : '',
							success : function(data) {
			...
			function getrating() {
				...
				$
						.ajax({
							url : '${pageContext.request.contextPath}/fundclient/getRating?mid='+master,
							type : 'get',
							async : false,
							data : '',
							success : function(data) {
			...
			function uncopyMaster() {
				...
				$
						.ajax({
							url : '${pageContext.request.contextPath}/fundclient/unCopyMaster?mid='+master,
							type : 'get',
							async : false,
							data : '',
							success : function(data) {
...
function getpositionGetByComment() {
				...
				$
						.ajax({
							url : '${pageContext.request.contextPath}/fundclient/positionGetByComment?mid='+master,
							type : 'get',
							async : false,
							data : '',
							success : function(data) {
							...
							success : function(data) {
								...
								if (data.result.indexOf("Master") >= 0) {
									...
									if(checkval())
										...
										$
										.ajax({
											url : '${pageContext.request.contextPath}/fundclient/copyMaster?mid='+master+'&r='+ratio+'&t='+copytype,
											type : 'get',
											async : false,
											data : '',
											success : function(data) {
			...
			function getprofileimg()
			{
				...
				$
				.ajax({
					url : '${pageContext.request.contextPath}/fundclient/getViewProfileImgUrl?id='+id,
					type : 'get',
					async : false,
						...
						if (data.result.indexOf("0 Done" >= 0)) {
							...
							if (jobject.retcode == "0 Done") {
								if (jobject.hasOwnProperty('answer')) {
									...
									if (Object.keys(Jarrayanswer).length > 0) {
										document.getElementById("userphoto").src = "${pageContext.request.contextPath}/fundclient/image/"+Jarrayanswer.url;
										document.getElementById("bgprofile").style.background = "url('${pageContext.request.contextPath}/fundclient/image/"+Jarrayanswer.url+"') center center";
									} else {
										document.getElementById("bgprofile").src = "${pageContext.request.contextPath}/fundclient/image/"+Jarrayanswer.url;
										document.getElementById("bgprofile").style.background = "url('${pageContext.request.contextPath}/fundclient/image/"+Jarrayanswer.url+"') center center";
			...
			function GetTotaltrade() {
				...
				$
						.ajax({
							url : '${pageContext.request.contextPath}/fundclient/GetTotalTradebyclient?mid='+master,
							type : 'get',
							async : false,
							data : $("#accountListFrm").serialize(),
							success : function(data) {
