						...
						<div class="col-12">
							<div class="card">
								<div class="card-header">
									<h3 class="card-title"> From an Account</h3>
									...
									<div class="row">
										<div class="col-md-12">
											<div class="form-group">
												<label>Withdrawal From (MT5 Account Number)</label> <input type="number" id="login" name="login"
													class="form-control"
											...
											<div class="form-group">
												<label>Withdrawal Amount (USD)</label> <input type="number"  id="money" name="money" class="form-control"
								...
								<div class="card-footer ">
									...
									<button type="button" class="btn btn-primary float-right"
										style="margin-left: 5px" id="withdrawalbtn">Withdrawal</button>
...
var newaccountinfo;
		...
		fetch(url)
		  ...
		  .then(data => {
			 ...
			 if(jobj.retcode.indexOf("0 Done")>=0)
				 {
				 jobj.answer.WithdrawalAmount = document.getElementById("money").value;
	...
	{ var url = '${pageContext.request.contextPath}/fundmanager/GetTargetAccountBalance?id='+id;
	 ...
	 function confirmWithdrawalAccount() {
			...
			$
					.ajax({
						url : "${pageContext.request.contextPath}/fundmanager/ConfirmWithdrawalAccount",
						type : 'post',
					    datatype : "application/json",
					    contentType: "application/json",
						async : true,
