...
var newaccountinfo;
	...
	{  
		$
		.ajax({
			url :'${pageContext.request.contextPath}/fundclient/CheckAccountAndGroup?id='+aid,
			type : 'get',
	...
	{ 
	 ...
	 function confirmCreateRequest() {
			...
			$
					.ajax({
						url : "${pageContext.request.contextPath}/fundclient/insertNewWithdrawalRequest",
						type : 'post',
					    datatype : "application/json",
					    contentType: "application/json",
						async : true,
						...
						success : function(data) {
								...
								if (jobject.retcode == "0 Done") {
									...
									window.location.href = '${pageContext.request.contextPath}/fundclient/FundWithdrawal'
								}
