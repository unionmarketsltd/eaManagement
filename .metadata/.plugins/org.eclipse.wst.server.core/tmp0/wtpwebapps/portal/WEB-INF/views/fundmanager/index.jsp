...
<body class="hold-transition sidebar-mini layout-fixed">
		...
		<div class="content-wrapper">
            ...
            <div class="card card-widget widget-user">
              ...
              <div class="card-footer" style="padding-top: 101px !important; padding-bottom: 95px !important;">
                ...
                <h5 class="widget-user-desc text-center" id="fab">0.00 USD</h5>
								</div>
            </div>
            <!-- /.widget-user -->
          </div>
								...
								<div class="col-md-12">
									...
									<div class="card card-primary">
										...
										<div class="card-body">
											...
											<p class="text-muted" id="country">${fmuser.companyname }</p>

											<hr>

											<strong><i class="fa fa-envelope mr-1"></i> Email</strong>

											<p class="text-muted" id="Email">${fmuser.email}</p>
											...
											<p class="text-muted">
												<span class="tag tag-danger" id="Phone">${fmuser.tel}</span>
											...
											<p class="text-muted" id="Address">${fmuser.contactname}</p>
										</div>
										<!-- /.card-body -->
									</div>
									<!-- /.card -->
				...
				success : function(data) {
					  ...
					  console.log(data.result);
						 if(jobj.retcode.indexOf("0 Done")>=0)
							...
							document.getElementById("fab").innerHTML = "Balance: <span style='color:green'>"+balance +"</span> USD";
	...
	/*	function GetOrderList(page) {
			$.ajax({
						url : '${pageContext.request.contextPath}/fundmanager/IndexGetInfo',
						type : 'get',
						async : false,
						data : '',
						success : function(data) {
