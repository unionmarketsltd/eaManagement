				...
				<div class="modal-content">
					...
					<div class="modal-body">
						...
						<div class="row ">
							...
							<label for="goodid">I Approved the ID document:</label> <input
									type="checkbox" id="goodid" name="goodid"> <br>
								<label for="goodpoa">I Approved the POA document:</label> <input
									type="checkbox" id="goodpoa" name="goodpoa">
									
									<br>
								<label for="group">Master Managers </label> 
...
<script type="text/javascript">
	...
	function createaccount() {
		...
		if(!document.getElementById("goodid").checked)
			{
			alert("please review and approved the ID document Before Proceed");
			return;
			}
		
		if(!document.getElementById("goodpoa").checked)
		{
		alert("please review and approved the POA document Before Proceed");
		return;
		}
