						...
						<div class="col-12">
							<div class="card">
								<div class="card-header">
									<h3 class="card-title"><a href="newtopic">Create New Request+</a></h3>
...
var currentPage = 0;
	...
	function convertUnixtoLocalTime(unixTimestamp) {
	 ...
	 function InitialFundConfugurationComment() {
	  ...
	  {
		  showloading(1);
		  var urla = '${pageContext.request.contextPath}/fundmanager/GetFundConfugurationComment';
		...
		nextPageButton.addEventListener('click', () => {
			...
			let count = 0;
			  ...
			  const comments = data.CommentConfiguration;
			  ...
			  for (let i = 0; i < comments.length; i++) {
				...
				if (currentPage < Math.ceil(count / itemsPerPage) - 1) {
				   ...
				   // console.log(JSON.parse(globaldata).CommentConfiguration.length);
				}
		});
		...
		function insertTableRowWithSelectedColumn(tableid, array,
			...
			for (let i = array.length - 1; i >= 0; i--) {
				...
				if (enableButtonAction) {
					...
					cell.innerHTML = "<a href='viewtopic?"+"status="+status+"&index=" + index+"&title="+title
