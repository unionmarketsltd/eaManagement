...
<br>
<br>
<a   class="btn btn-primary btn-block" href="${pageContext.request.contextPath}/fundclient/login">Go to Login Page</a></div>
...
function check(){
	...
	$.ajax({
		url : '${pageContext.request.contextPath}/fundclient/resetPassword',
		type : 'get',
		async: true,
